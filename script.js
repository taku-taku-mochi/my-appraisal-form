...
// --- DOMContentLoaded: Wait for the entire page to load before running scripts ---
document.addEventListener('DOMContentLoaded', () => {

    // --- DOM ELEMENTS (safe to get them now) ---
    ...
    // --- GET DYNAMIC DOM ELEMENTS (now they exist) ---
    ...
    // --- EVENT LISTENERS (now safe to attach) ---
